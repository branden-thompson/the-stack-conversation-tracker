  ...
  return {
    unit: {
      ...
      files: [
        ...
        { name: 'TimelineNode.test.jsx', tests: 14, passed: 14, failed: 0 },
        { name: 'ConversationTimeline.test.jsx', tests: 9, passed: 9, failed: 0 },
        { name: 'timelineConstants.test.js', tests: 8, passed: 8, failed: 0 },
        { name: 'timelineEvents.test.js', tests: 18, passed: 18, failed: 0 },
        { name: 'useExpansionState.test.js', tests: 9, passed: 9, failed: 0 }
      ]
    },
    integration: {
      total: 81,
      ...
      files: [
        ...
        { name: 'TreeListViewSwitching.test.jsx', tests: 12, passed: 12, failed: 0 }
      ]
    }
  };
}
