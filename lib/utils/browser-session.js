...
export function getBrowserSessionId() {
  ...
  try {
    ...
    if (!browserSessionId) {
      ...
      console.log('[BrowserSession] Created new browser session:', browserSessionId);
    } else {
      console.log('[BrowserSession] Retrieved existing browser session:', browserSessionId);
    }
...
export function clearBrowserSessionId() {
  ...
  if (browserSessionId) {
    console.log('[BrowserSession] Clearing browser session:', browserSessionId);
