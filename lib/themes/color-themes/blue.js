...
export const blueTheme = {
  ...
  // Dark mode colors - dark blue theme with darker zones
  dark: {
    primary: 'bg-sky-50 dark:bg-sky-950',
    secondary: 'bg-white dark:bg-sky-950',
    tertiary: 'bg-sky-100 dark:bg-sky-900',
    card: 'bg-sky-50 dark:bg-sky-800',
    dropdown: 'bg-white dark:bg-sky-950',
    hover: 'hover:bg-sky-50 dark:hover:bg-sky-900/50',
    hoverStrong: 'hover:bg-sky-100 dark:hover:bg-sky-800',
    accent: 'bg-sky-50 dark:bg-sky-800',
    divider: 'bg-sky-300 dark:bg-sky-700',
    
    border: {
      primary: 'border-sky-200 dark:border-sky-800',
      secondary: 'border-sky-300 dark:border-sky-700',
      strong: 'border-sky-400 dark:border-sky-600',
    },
    ...
    cardTypes: {
      topic: {
        container: 'bg-white border-sky-300 text-slate-800 dark:bg-sky-800 dark:border-sky-700 dark:text-sky-100',
