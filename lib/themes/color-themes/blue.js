...
export const blueTheme = {
  ...
  // Dark mode colors - entire theme ramped darker by 1
  dark: {
    primary: 'bg-sky-50 dark:bg-slate-950',
    secondary: 'bg-white dark:bg-slate-950',
    tertiary: 'bg-sky-100 dark:bg-sky-950',
    card: 'bg-sky-50 dark:bg-sky-900',
    dropdown: 'bg-white dark:bg-slate-950',
    hover: 'hover:bg-sky-50 dark:hover:bg-sky-950/50',
    hoverStrong: 'hover:bg-sky-100 dark:hover:bg-sky-900',
    accent: 'bg-sky-50 dark:bg-sky-900',
    divider: 'bg-sky-300 dark:bg-sky-800',
    
    border: {
      primary: 'border-sky-200 dark:border-sky-900',
      secondary: 'border-sky-300 dark:border-sky-800',
      strong: 'border-sky-400 dark:border-sky-700',
    },
    
    text: {
      primary: 'text-slate-900 dark:text-sky-50',
      secondary: 'text-slate-700 dark:text-sky-100',
      tertiary: 'text-slate-600 dark:text-sky-200',
      muted: 'text-slate-500 dark:text-sky-300',
      light: 'text-slate-400 dark:text-sky-400',
    },
    
    cardTypes: {
      topic: {
        container: 'bg-white border-sky-300 text-slate-800 dark:bg-sky-900 dark:border-sky-800 dark:text-sky-100',
        borderColor: 'border-sky-300 dark:border-sky-800',
        background: 'bg-white dark:bg-sky-900',
        text: 'text-slate-800 dark:text-sky-100',
      },
      question: {
        container: 'bg-blue-50 border-blue-300 text-blue-900 dark:bg-blue-900 dark:border-blue-600 dark:text-blue-100',
